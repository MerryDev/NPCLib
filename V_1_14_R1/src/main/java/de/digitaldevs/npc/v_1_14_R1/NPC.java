...
/**
 * This class represents an NPC in minecraft's version 1.14
 *
...
public class NPC implements AbstractNPC {
    ...
    public void sneak(boolean state) {
        ...
        dataWatcher.set(new DataWatcherObject<>(18, DataWatcherRegistry.s), state ? EntityPose.SNEAKING : EntityPose.STANDING);
